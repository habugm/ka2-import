    ...
    <div className="row justify-content-between gy-4">
      <div className="col-lg-6 d-flex align-items-center">
        <div className="content">
          ...
          <p>Today, KA2 General Import and Export have above 50 skilled and dedicated staff members who are the backbone of our success and we have around $1,100,000.00 annual transaction. Together, we continue to expand our reach and strengthen our role as a trusted supplier across Ethiopia and beyond.</p>
